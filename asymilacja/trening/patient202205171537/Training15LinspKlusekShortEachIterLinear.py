...
df_true = pd.read_csv("data/klusek/patient202205171537/stats0.csv")
from data.klusek.patient202205171537.config import threatment_start, threatment_end,threatment2_start
