...
from asymilacja.trening.kalman.utils import PlotOneSerie
...
PlotOneSerie(t[:-1],Xs,label="Zastosowanie filtru Kalmana w procesie asymilacji",color='green')
plt.plot(t,P,'--', linewidth=1,color='black', label="model czasowo-przestrzenny 3d")
