...
def g(t, x0, paras):
    ...
    x = solve_ivp(f,[t[0],t[-1]], x0, t_eval=t,args=(paras,))
    return x
...
params.add('K', value=0.3e6, min=0.1e6, max=2.e6)
...
P_fitted = data_fitted.y[0,:]
C_fitted =data_fitted.y[1,:]
